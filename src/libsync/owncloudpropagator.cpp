...
void PropagateItemJob::done(SyncFileItem::Status statusArg, const QString &errorString, ErrorCategory category)
{
...
ErrorCategory PropagatorJob::errorCategoryFromNetworkError(QNetworkReply::NetworkError error)
{
