...
void SyncEngine::setupDiscoveryPhase(const QStringList &selectiveSyncBlackList, const QStringList &selectiveSyncWhiteList)
{
    ...
    _discoveryPhase->_shouldDiscoverLocaly = [this](const QString &path) { return shouldDiscoverLocally(path); };
    ...
    auto discoveryJob = new ProcessDirectoryJob(_discoveryPhase.data(),
