...
void SyncEngine::slotCleanPollsJobAborted(const QString &error, ErrorCategory errorCategory)
{
...
void SyncEngine::slotItemCompleted(const SyncFileItemPtr &item, ErrorCategory category)
{
